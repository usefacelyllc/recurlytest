...
interface SexyQuizPageProps {
  onBack: () => void;
  onContinue: () => void;
}

const SexyQuizPage: React.FC<SexyQuizPageProps> = ({ onBack, onContinue }) => {
  ...
  return (
    <div className="bg-complementar text-apoio min-h-screen font-sen">
      <div className="max-w-sm mx-auto py-6 px-4">
        ...
        <ProgressBar currentStep={1} totalSteps={3} activeSection={2} />
