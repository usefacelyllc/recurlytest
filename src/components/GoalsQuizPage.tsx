...
const GoalsQuizPage: React.FC<GoalsQuizPageProps> = ({ onBack, onContinue }) => {
  const { quizData, updateQuizData } = useQuiz();
  const [selectedGoals, setSelectedGoals] = useState<string[]>(quizData.goals || []);
  ...
  return (
    <div className="bg-complementar text-apoio min-h-screen font-sen">
      <div className="max-w-sm mx-auto py-6 px-4 w-full pb-32">
        ...
        {/* Reuse Progress Bar state from previous step roughly, or advance it */}
